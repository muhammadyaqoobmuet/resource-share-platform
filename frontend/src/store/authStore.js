...
const useAuthStore = create((set) => ({
    ...
    signup: async (data) => {
        ...
        try {
            const response = await axios.post("https://backend-production-04f5.up.railway.app/auth/signup", data);
            set({ isLoading: false });
    ...
    login: async (data) => {
        set({ isLoading: true, error: null });
        try {
            const response = await axios.post("https://backend-production-04f5.up.railway.app/auth/login", data);
    ...
    verify: async (data) => {
        set({ isLoading: true, error: null });
        try {
            const response = await axios.post("https://backend-production-04f5.up.railway.app/auth/verify", data);
